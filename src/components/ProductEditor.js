...
export default function ProductEditor(props) {
  ...
  function deleteEnvironmentRequirement(index) {
    setEnvironmentRequirements(
      environmentRequirements.filter((environmentRequirement, i) => index !== i)
    );
  }
      ...
      <Grid container direction="column" spacing={1}>
        ...
        <Grid item xs={10} className={classes.inputField}>
          <FormControl fullWidth>
            <InputLabel htmlFor="demo-customized-select-native" required>
              Lifecycle status
            </InputLabel>
            <Select
        ...
        <Grid item xs={10} className={classes.inputField}>
          <Autocomplete
            ...
            autoComplete
            renderInput={params => (
              <TextField {...params} fullWidth label="Sales person" />
            )}
          />
        </Grid>
        <Grid item xs={10} className={classes.inputField}>
        ...
        <Grid item xs={10} className={classes.inputField}>
          <div>
            <Autocomplete
              onInputChange={handleAutoCompleteChange("technology")}
              ...
              renderInput={params => (
                <TextField {...params} fullWidth label="Technologies" />
              )}
            />
          </div>
        </Grid>
        ...
        <Grid item xs={10} className={classes.inputField}>
          <div>
            <Autocomplete
              onInputChange={handleAutoCompleteChange("component")}
              ...
              renderInput={params => (
                <TextField {...params} fullWidth label="Components" />
              )}
            />
          </div>
        </Grid>
        ...
        <Grid item xs={10} className={classes.inputField}>
          <div>
            <Autocomplete
              onInputChange={handleAutoCompleteChange("environmentRequirement")}
              options={properties.environmentRequirements}
              getOptionLabel={({ requirement }) => requirement}
              onKeyDown={handleAutoCompleteKeyDown("environmentRequirement")}
              freeSolo
              autoSelect
              autoComplete
        ...
        <Grid item xs={10} style={{ padding: "0" }}>
          <div className={classes.chipContainer}>
            {environmentRequirements.map((environmentRequirement, i) => (
              <Chip
                key={i}
                label={environmentRequirement}
                onDelete={() => deleteEnvironmentRequirement(i)}
                className={classes.chip}
              />
            ))}
          </div>
        ...
        <Grid item xs={12}>
          ...
          {image && (
            <img className={classes.img} src={image} alt="product logo" />
          )}
        </Grid>
      </Grid>
