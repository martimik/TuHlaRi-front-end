...
export default function CreateProduct() {
  ...
  function readKey(event) {
    if (event.key === "Enter") {
      event.preventDefault();
      const { component, technology, environmentRequirement, customer } = input;
    ...
    if (event.key === "Backspace" && !event.target.value) {
      switch (event.target.name) {
        ...
        case "technology":
          ...
          break;
        case "environmentRequirement":
          deleteEnvironmentRequirement(environmentRequirements.length - 1);
          break;
        case "customer":
        ...
        >
          ...
          <Grid item xs={6}>
            ...
            >
              ...
              <img
                className={
                  imageIshidden ? classes.imgHidden : classes.imgVisible
                }
                src={image}
                alt=""
              />
